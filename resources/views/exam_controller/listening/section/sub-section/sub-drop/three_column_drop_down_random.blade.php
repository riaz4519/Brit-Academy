...
@section('title','Three column Drop down')
            ...
            <div class="col-6 offset-3">
                ...
                <div class="card">
                    ...
                    <div class="card-header text-center">
                        ...
                        <span>{{ $lsubsection->ltypes->name }}</span>

                    </div>

                    <div class="card-body">

                        <form action="{{ route('listening.sub.three_column_drop_store',['listening_id'=>Request::Segment(3),'section_id'=>Request::Segment(5),'sub_section_id'=>$lsubsection->id]) }}" method="post">
            ...
            $('.button-number').on('click',function () {
                ...
                if(numberOfOption >0){
                    ...
                    for (var i = 0;i<numberOfOption;i++){
                        ...
                        html +='<div class="form-row"> <div class="form-group col"> <input type="text" name="option[]" class="form-control" placeholder="option'+(i+1)+'" required> </div><div class="form-group col"> <input type="text" name="value[]" class="form-control" placeholder="value'+(i+1)+'" required> </div> </div>';
