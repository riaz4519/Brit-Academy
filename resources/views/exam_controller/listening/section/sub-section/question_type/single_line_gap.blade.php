...
@section('title','Sinlge Line Questions')
        ...
        <div class="row mt-5">
            ...
            <div class="col-7 offset-3">
                ...
                <div class="card">
                    ...
                    <form method="post" action="{{ route('listening.sub.single_line_store',['listening_id'=>Request::Segment(3),'section_id'=>Request::Segment(5),'sub_section_id'=>$lsubsection->id]) }}" >
                        {{csrf_field()}}
