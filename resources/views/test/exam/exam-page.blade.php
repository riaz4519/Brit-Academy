                                        ...
                                        <div class="mt-3">
                                            ...
                                            @foreach($rsub->rquestions as $rquestion)
                                                <div class="form-group row">
                                                    ...
                                                    <select class="col-2 form-control  input-sm" name="question[{{$rquestion->number}}]">
                                                        <option></option>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    @foreach($rquestion->qoptions as $roption)
                                                        ...
                                                        <div class="form-check">
                                                            <strong class="mr-4 text-center">{{$roption->option}}.</strong><input class="form-check-input" name="question[]" type="radio" value="" id="defaultCheck1">
                ...
                <script>
                    ...
                    $(document).ready(function () {
                        ...
                        $('.passage-drop').each(function () {
                            ...
                            input += '</span>';
                            input += '<select name="question['+ value +']" class="option-width form-control">';
                            input +='<option></option>'
                            @foreach($rsub->rdrops as $rdrop)
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.passage-gap').each(function () {
                ...
                var value = $(this).html();
                var input  = '<span class="green-number"> '+value+' </span> <input type="text" name="question['+value+']">';
                $(this).html(input);
